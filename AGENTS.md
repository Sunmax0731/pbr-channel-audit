...
この repo は `pbr-channel-audit` の closed alpha 実装単位です。

## Scope

- Root: `D:\AI\AssetPipeline\pbr-channel-audit`
- Domain: AssetPipeline
- Product kind: asset-pipeline
- Source pack: `D:/AI/AssetPipeline/created_idea_002_pbr-channel-audit/idea_002_pbr-channel-audit.zip`
- Public repo: `https://github.com/Sunmax0731/pbr-channel-audit`

## Working Rules

- README、AGENTS、SKILL、docs を同じ変更単位で更新する。
- created_idea は `D:/AI/AssetPipeline/created_idea_002_pbr-channel-audit` を正とし、同梱 ZIP の `metadata.json` と repo 名が一致することを確認する。
